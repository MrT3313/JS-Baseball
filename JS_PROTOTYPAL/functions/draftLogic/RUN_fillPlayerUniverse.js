// -*- IMPORTS -*- //
    // -A- // ES6 Imports
    import ES6_INHERITANCE_playerObject from '../../inheritance/playerObject.js.js'
    import ES6_DATA_playerUniverse from '../../data/playerUniverse.js.js'
...
const fillPlayerUniverse = (playerUniverse) => {
    ...
    // --*-- //
    playerUniverse.forEach((positionArray, i) => {
