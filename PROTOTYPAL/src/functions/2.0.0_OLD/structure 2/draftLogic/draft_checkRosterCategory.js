        ...
        */
        case 'infield':
            result = team.checkPosition(team, 'infielders')
                console.log('-x- Current Position Array Length: ',team.teamPlayers['infielders'].length)
                console.log('-x- Check Position Result: ', result)

            if (result === false) {
                console.log(`-x- Draft Update: ${categoryCheck_SUCCESS}`)

                team.teamPlayers['infielders'].push(selection)
                return team
            } else {
                console.log(`-x- !!! Draft Update: ${categoryCheck_FAILURE} !!!`)
        ...
        case 'outfield':
            result = team.checkPosition(team, 'outfielders')
                console.log('-x- Current Position Array Length: ', team.teamPlayers['outfielders'].length)
                console.log('-x- Check Position Result: ', result)
        ...
        case 'pitcher':
            result = team.checkPosition(team, 'pitchers')
                console.log('-x- Current Position Array Length: ', team.teamPlayers['pitchers'].length)
                console.log('-x- Check Position Result:',result)
